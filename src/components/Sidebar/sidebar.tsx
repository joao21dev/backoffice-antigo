...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: "Boletos", icon: FiUser, routh: "boletos" },
  { name: "Cartões", icon: FiUser, routh: "accounts" },
  { name: "Compras", icon: FiUser, routh: "compras" },
  { name: "Saques", icon: FiUser, routh: "cashout" },
  { name: "Pagamentos", icon: FiUser, routh: "payments" },
  { name: "Transferência Pix", icon: FiUser, routh: "pix" },
  { name: "Transferência P2P", icon: FiUser, routh: "p2p" },
  { name: "Transferência TED", icon: FiUser, routh: "ted" },
